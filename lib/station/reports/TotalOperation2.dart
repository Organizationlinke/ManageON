...
class CropReportScreen2 extends StatefulWidget {
  const CropReportScreen2({super.key});

  @override
  State<CropReportScreen2> createState() => _CropReportScreenState();
}

class _CropReportScreenState extends State<CropReportScreen2> {
